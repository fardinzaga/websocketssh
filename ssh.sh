...
sed -i 's/DROPBEAR_EXTRA_ARGS=/DROPBEAR_EXTRA_ARGS="-p 77 -p 2000 -p 4000 -p 187 -p 143 -p 109 "/g' /etc/default/dropbear
...
ExecStart=/usr/bin/python -O /usr/local/bin/edu-proxy 2052
Restart=on-failure
[Install]
WantedBy=multi-user.target
END
