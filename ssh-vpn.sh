...
sed -i '/Port 22/a Port 365' /etc/ssh/sshd_config
...
sed -i 's/DROPBEAR_EXTRA_ARGS=/DROPBEAR_EXTRA_ARGS="-p 77 -p 2000 -p 4000 -p 276 -p 381 -p 187 -p 143 -p 109 "/g' /etc/default/dropbear
